...
const renderEmail = (queryData, type) => {
  ...
  ` : `
    ...
    <p style="font-size: 13.5px; line-height: 1.6; color: #444; margin-bottom: 15px;">
      Thank you for contacting <strong>Exim Guru Mantra</strong>. Your advisory request has been successfully queued under Ticket ID <strong>#${id}</strong> and is currently being processed by our compliance desk.
    </p>
